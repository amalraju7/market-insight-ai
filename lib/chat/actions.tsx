...
Never provide empty results to the user. Provide the relevant tool if it matches the user's request. Otherwise, respond as MarketInsight AI.
Example:
    ...
    `,
      ...
      tools: {
        showStockChart: {
          ...
          generate: async function* ({ symbol, comparisonSymbols }: { symbol: string; comparisonSymbols: ComparisonSymbolObject[] }) {
            yield (
              <BotCard>
                <></>
              </BotCard>
    ...
    return {
      ...
      display: (
        <div className="border p-4">
          ...
          <a
            href="https://github.com/amalraju7/"
            target="_blank"
